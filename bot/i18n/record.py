...
EN: dict[str, str] = {
    ...
    "record.noCategories": "You have no categories for this yet — add them in the web app.",
...
UZ: dict[str, str] = {
    ...
    "record.useCategory": "✓ {name}",
    "record.noCategories": "Bunga hali kategoriyalaringiz yoʻq — ularni veb-ilovada qoʻshing.",
